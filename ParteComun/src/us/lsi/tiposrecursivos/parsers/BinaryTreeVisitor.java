...
public interface BinaryTreeVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 */
	T visitLabelTree(@NotNull BinaryTreeParser.LabelTreeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdLabel(@NotNull BinaryTreeParser.IdLabelContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEmptyTree(@NotNull BinaryTreeParser.EmptyTreeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBinaryTree(@NotNull BinaryTreeParser.BinaryTreeContext ctx);
}